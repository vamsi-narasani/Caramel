...
<jsp:useBean id="sampleHelloWorldProxyid" scope="session" class="com.webservice.example.HelloWorldProxy" />
<%
...
case 10:
        gotMethod = true;
        com.webservice.example.HelloWorld getHelloWorld10mtemp = sampleHelloWorldProxyid.getHelloWorld();
